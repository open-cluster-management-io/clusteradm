...
import (
	...
	"open-cluster-management.io/clusteradm/pkg/cmd/upgrade/klusterlet/scenario"
...
func (o *Options) validate() error {
	...
	fmt.Printf("Klusterlet installed. starting upgrade ")
...
func (o *Options) run() error {
	...
	out, err := applier.ApplyDeployments(reader, o.values, o.ClusteradmFlags.DryRun, "", "klusterlet/operator.yaml")
	if err != nil {
		return err
	}
	...
	out, err = applier.ApplyCustomResources(reader, o.values, o.ClusteradmFlags.DryRun, "", "klusterlet/klusterlets.cr.yaml")
	if err != nil {
		return err
	}
	output = append(output, out...)
